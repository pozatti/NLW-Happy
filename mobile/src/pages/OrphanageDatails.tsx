...
interface OrphanageDetailRoute {
    id: number;
}
...
export default function OrphanageDetails() {
    ...
    const param = route.params as OrphanageDetailRoute;
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.detailsContainer}>
                ...
                <View style={styles.mapContainer}>
                    ...
                    <TouchableOpacity onPress={handleGoogleMaps} style={styles.routesContainer}>
